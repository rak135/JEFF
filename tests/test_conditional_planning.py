...
from jeff.cognitive.proposal import ProposalOption
...
def _selected_option(*, planning_needed: bool = False) -> ProposalOption:
    return ProposalOption(
        proposal_id="proposal-1",
        proposal_type="planning_insertion" if planning_needed else "direct_action",
        option_summary="Implement the bounded multi-step path",
